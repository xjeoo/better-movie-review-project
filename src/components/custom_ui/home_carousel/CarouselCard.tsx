        ...
        <div className="relative w-full h-[480px] sm:h-[900px] items-center justify-center overflow-hidden select-none">
          ...
          <div className="z-20 absolute left-[5%]  bottom-[15%] sm:bottom-[35%]">
            <div className="flex flex-col max-w-full sm:max-w-[55vw] gap-4 ">
              <h2 className="text-3xl sm:text-5xl xl:text-6xl font-semibold text-white text-pretty">
                {movie.title}
              </h2>
              <span className="text-neutral-200 text-[1.15em]">
                {movie.release_date.split("-")[0]}
              </span>
              <div className="hidden sm:flex flex-wrap basis-[100%]  gap-3">
              ...
              <Link
                href={`/movie/${movie.id}`}
                className="py-1.5 px-5 w-fit text-[18px] sm:text-2xl bg-blue-primary-darker text-white rounded-md mt-6 md:hover:bg-blue-primary-darker-100"
              >
                View
              </Link>
            </div>
