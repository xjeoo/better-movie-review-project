...
const CrewCarousel = ({ info }: { info: any }) => {
  return (
    <div className="relative">
      <div className="absolute -left-1 w-[15%] h-full bg-gradient-to-r from-black to-transparent z-10"></div>
      <div className="absolute -right-1 w-[15%] h-full bg-gradient-to-l from-black to-transparent z-10"></div>
      <Carousel>
        <CarouselContent>
